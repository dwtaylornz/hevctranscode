...
# Paths 
$media_path = "C:\temp\hevctranscode\test\" # path to videos (if smb, must include trailing backslash) 
...
$min_video_size = 0.5 # min size in GB of video before it will quit
